...
function setup(){
  ...
  pTurtle = createSprite(1000,1000)
...
function draw(){
 ...
 if (gameState === "badEnd"){
   ...
   text("Your Score : " + score, width/2-450, height/2 );
   text("Better Luck next Time!", width/2 - 600, height/2 + 200);
 }

 if (gameState === "goodEnd"){
 
   textSize(120);
   text("Well Done!!",width/2- 400 ,height/2 - 100);
   text("Your Brilliant Score is :"+ score,width/2 - 700,height/2 + 150);
 }
